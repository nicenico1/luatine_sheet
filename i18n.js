...
(function () {
    ...
    const I18N = {
        fr: {
            ...
            journal_summary_heading: 'Sommaire',
            journal_summary_hint:
                'Chaque ligne ouvre la double-page dont le numéro de page (coin de la page) correspond. Ex. « 30 » ou « Page 30 ».',
            journal_summary_title_ph: 'Titre affiché (ex. 15 mai 2014 — Le jour rouge)',
            journal_summary_page_ph: 'Numéro de page',
            journal_summary_add: 'Ajouter une entrée',
            journal_summary_remove: 'Supprimer',
            journal_summary_not_found: 'Aucune page ne correspond à ce numéro. Vérifiez le coin de page sur chaque feuille.',
            sync_idle: 'Cloud',
        ...
        en: {
            ...
            journal_summary_heading: 'Summary',
            journal_summary_hint:
                'Each entry jumps to the spread whose page label matches. Use the number in the page corner, e.g. « 30 » or « Page 30 ».',
            journal_summary_title_ph: 'Display title (e.g. May 15th 2014 — The red day)',
            journal_summary_page_ph: 'Page number',
            journal_summary_add: 'Add entry',
            journal_summary_remove: 'Remove',
            journal_summary_not_found: 'No page matches that number. Check the page label at the bottom of each sheet.',
            sync_idle: 'Cloud',
            sync_syncing: 'Saving…',
            sync_synced: 'Saved',
